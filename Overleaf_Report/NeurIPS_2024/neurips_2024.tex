...
Several key artifacts for this project were uploaded into a centralized code repository using GitHub at:
\url{https://github.com/GandyLandKY/CSE590_NLP_Team_Fowlkes_Gandy_Code/blob/main/Fowlkes_Gandy_Project_CSE590_51.ipynb}

In this repository you will find the output from the Jupyter session, the Docker objects necessary to set up the project, instructions to set up the project, and the test data used to run the project. This test data is manufactured and does not show a true multi-faceted output. I was not able to use my work machine due to recent changes mandated by legal.
